...
turn:
    enabled: true
    domain: livekit-turn.doctorkit.satmed.net
    tls_port: 5349
    udp_port: 3478
    external_tls: true
keys:
    APIgNxWzk3h8fpH: eTMC1y4k94cOyo1Y1zj5i0eVO6eGoe75CIjebOg4j6bB
...
apps:
  tls:
    certificates:
      automate:
        - livekit.doctorkit.satmed.net
        - livekit-turn.doctorkit.satmed.net
  layer4:
    servers:
      main:
        listen: [":443"]
